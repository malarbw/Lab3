 ...
 * Brad Malarkey
 * 
 * Lab 3 -- prompt user to enter integer, display table of squares and cubes
 */
...
public class Squares_Cubes {
	...
	public static void main(String[] args) {
		...
		while (cont.equalsIgnoreCase("y")) { //use while loop so that program only runs while the user continues to enter y || Y
